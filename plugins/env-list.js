...
async (conn, mek, m, { from, quoted, reply }) => {
    try {
        ...
        let envSettings = `╭━━━〔 *MeHaR-Waleed-MD* 〕━━━┈⊷
┃▸╭───────────
┃▸┃๏ *ENV SETTINGS 🗿*
┃▸└───────────···๏
╰────────────────┈⊷
...
> ${config.DESCRIPTION}`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: 'https://i.ibb.co/G399DW98/3820.jpg' }, // Image URL
                caption: envSettings,
                contextInfo: {
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/ladla-malik/Ladla-Session-main/raw/refs/heads/main/autovoice/menunew.m4a' }, // Audio URL
            mimetype: 'audio/mp4',
            ptt: true
        }, { quoted: mek });
